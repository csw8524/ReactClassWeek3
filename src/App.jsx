        ...
        <div>
          <div className="container">
            <div className="text-end mt-4">
              <button onClick={openProductModal} type='button' className="btn btn-primary">建立新的產品</button>
            </div>
        ...
        <div className="modal-dialog modal-xl">
          <div className="modal-content border-0">
            ...
            <div className="modal-footer">
              ...
              <button onClick={createProduct} type="button" className="btn btn-primary">確認</button>
            </div>
          </div>
        </div>
      </div>
